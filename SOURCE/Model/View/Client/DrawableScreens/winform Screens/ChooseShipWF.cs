    ...
    public partial class ChooseShipWF : Form, IScreenControls
    {
        ...
        public void MouseUpdate(GameTime gt, MouseClass mc)
        {
            ...
            if (c == createnewshipbutton)
            {
                ...
                ri.Add(RequiredItem.GetRIString(CreateNewShipNameString, "ship name"));
            ...
            else if (c == selectdefault)
            {
                ...
                PlayerShipClass pscchoose = loadXML.loadedPlayerShips[ChooseShipListBox.SelectedItem.ToString()];
        ...
        public void UpdateChooseShipButton()
        {
            ...
            else
            {
                ...
                try
                {
                    PlayerShipClass psc = loadXML.loadedPlayerShips[ChooseShipListBox.SelectedItem.ToString()];
