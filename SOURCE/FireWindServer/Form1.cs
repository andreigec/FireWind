...
";
		...
		private Licensing.DownloadedSolutionDetails GetLicense()
		{
			var d = new Licensing.DownloadedSolutionDetails();
			d.ChangeLog = "https://raw.github.com/andreigec/" + RepoName + "/master/INFO/changelog.txt";
			d.Version = 1.1;
			d.ZipFileLocation = "https://github.com/andreigec/" + RepoName + "/zipball/master";
			return d;
		}
		...
		private void Form1_Load(object sender, EventArgs e)
		{
			...
			var sd = new Licensing.SolutionDetails(GetLicense, HelpString, AppTitle, AppVersion, OtherText);
			Licensing.CreateLicense(this, menuStrip1, sd);
		...
		public static void AddLog(ListView lv, int clientID, String text, Message m, SynchMain.MessagePriority priority,
								  bool isError)
		{
		...
		private static void addItemToLVF(ListView lv, FormMessageStore m2)
		{
			...
			string alias = mainserver.GetAlias(m2);
			...
			Tuple<Color, Color> t = getColour(m2.priority, m2.isError);
